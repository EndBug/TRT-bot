module.exports = (name, v1, v2, v3) => {
  ...
  let messages = {
    ...
    "err-no-music": `[ERR] There's no music playing in your channel. Start playing music \`${v1}\` or move another bot with \`${v2}\``,
    "err-no-voice": "[ERR] You're not in a voice channel.",
    ...
    "music-choose": "I found these videos, reply with the number of the one you want to play:",
    "music-nan": `\`${v1}\` is not a number, reply with a number from 1 to ${v2}. (e.g. \`${v3}\`)`,
    "music-nodj": "Sorry, but at the moment there's no DJ available :confused:\nTry again later!",
    "music-range": `\`${v1}\` is not in the results range, reply with a number from 1 to ${v2}. (e.g. \`${v3}\`)`,
